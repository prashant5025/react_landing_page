    ...
    <div className='w-full bg-white py-16 px-4'>
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
        ...
        <div className='flex flex-col justify-center'>
          ...
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis mollitia sapiente molestias sint aliquid fugiat culpa quaerat non commodi numquam explicabo dolore facere, aut id cum corporis earum ipsum dolor.</p>
